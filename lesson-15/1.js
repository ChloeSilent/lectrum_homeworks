...
sum.delay = delayInitial;
sum.delay(1000)(5, 2); /* Выведет 7 через 1 секунду. */
/**
 * Задача 1: Выполнена верно. Хорошее решение с использованием современных подходов.
 */